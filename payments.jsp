                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">           
                            ...
                            <li><a href="payments.jsp" class="menu-top-active" >PAYMENTS TABLE</a></li>
    ...
    <div class="content-wrapper">
    	...
    	<input type="hidden" id="hdelete" name="hdelete" />
         ...
         <div class="container">      
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>                                   
	                                	...
	                                	try
	                                	{
	                                		PreparedStatement ps=con.prepareStatement("SELECT * FROM WEPARKPAYMENT");
	                                		...
	                                		{
	                                			%><tr class="odd gradeX">
		                                			<td><%out.print(rs.getString("PAYMENTID"));%></td>
    		...
    		<a class="btn btn-info pull-right btn-sm" href="http://localhost:8088/WePark/reports/report.jsp?report=adminPayment" target="_blank">Generate Report</a>
