			  ...
			  <header id="header" id="home">
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="home.jsp"><img src="img/logo.png" alt="" title="" class="logo"/></a>
				      </div>
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						...
						<div class="col-lg-5  col-md-6 header-right">
							...
							<form action="home.jsp" class="form" role="form" autocomplete="off" method="POST">
							    
							    <div class="form-group">
							       	
										<input type="text" required="required" id="placetopark" name="placetopark" placeholder="     Where do you want to park?" style="width:400px; height: 40px; border-radius: 8px; outline: none; border: none;">
					...
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="single-feature">
								...
								<p>
									Choose from millions of spaces across Bangalore Find your best option for every car journey
								</p>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-feature">
								...
								<p>
									Pay for WePark spaces via website Follow easy directions and access instructions
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-6 col-sm-6" style="margin-right: 150px">
							<div class="single-footer-widget">
								<h6>Quick Links</h6>
								<ul>
									<li><a href="signUpLogin.html">Login</a></li>
									<li><a href="signUpLogin.html">Sign Up</a></li>									
									<li><a href="#">Home</a></li>
								</ul>								
							</div>
						</div>
