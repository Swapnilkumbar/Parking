...
<form action="usertable.jsp" method="post" name="form">
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">           
                            ...
                            <li><a href="usertable.jsp" class="menu-top-active" >USER TABLE</a></li>
	                                	...
	                                	try
	                                	{
	                                		...
	                                		while(rs.next())
	                                		{
	                                			%><tr class="odd gradeX">
		                                			...
		                                			<td><a href="updateUser.jsp?id=<%=rs.getString("USERID")%>&tablename=WEPARKUSERS">UPDATE</a>
		                                			<a href="deleteProcess.jsp?id=<%=rs.getString("USERID")%>&tablename=WEPARKUSERS&action=DELETE">DELETE</a></td>
    ...
    <a class="btn btn-info pull-right btn-sm" href="http://localhost:8088/WePark/reports/report.jsp?report=adminUsers" target="_blank">Generate Report</a>
