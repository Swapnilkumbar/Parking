...
<form action="usertable.jsp" method="post" name="form">
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">           
                            ...
                            <li><a href="parkingtable.jsp" class="menu-top-active" >PARKING SLOT TABLE</a></li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>                                   
	                                	...
	                                	try
	                                	{
	                                		PreparedStatement ps=con.prepareStatement("SELECT * FROM WEPARKPARKINGSLOTS");
	                                		...
	                                		while(rs.next())
	                                		{
	                                			%><tr class="odd gradeX">
		                                			...
		                                			<td><%out.print(rs.getString("PLACENAME"));%></td>
		                                			<td><%out.print(rs.getString("ADDRESS"));%></td>
		                                			<td><%out.print(rs.getString("PHONENO"));%></td>
		                                			<td><%out.print(rs.getString("PRICE"));%></td>
		                                			<td><a href="updateParking.jsp?id=<%=rs.getString("PARKINGSLOTID")%>&tablename=WEPARKPARKINGSLOTS">UPDATE</a>
		                                			<a href="deleteProcess.jsp?id=<%=rs.getString("PARKINGSLOTID")%>&tablename=WEPARKPARKINGSLOTS&action=DELETE">DELETE</a></td>
    ...
    <a class="btn btn-info pull-right btn-sm" href="http://localhost:8088/WePark/reports/report.jsp?report=adminParking" target="_blank">Generate Report</a>
